...
# Solutions agree with my Python program of the same name
# Still needs some repeat testing
...
# Display values
disp ("Azimuth velocity in arcsec/sec:"), disp (azV)
disp ("Elevation velocity in arcsec/sec:"), disp (elV)
